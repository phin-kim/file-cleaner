    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="relative overflow-hidden bg-slate-900 py-24 text-white">
                ...
                <div className="absolute top-1/2 left-1/2 -z-10 h-200 w-200 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-600/10 blur-[200px]" />
            </section>
                ...
                <section className="bg-slate-50 py-32">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <div className="flex flex-col justify-center gap-4 sm:flex-row">
                            <button
                                onClick={() => navigate('/auth')}
                                className="rounded-4xl bg-slate-900 px-12 py-5 font-black text-white transition-all hover:bg-slate-800 active:scale-95"
                            >
                                Create Account
                            </button>
                        </div>
